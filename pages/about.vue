<template>
  <main class="page-wrapper">
      ...
      <div class="row align-items-center justify-content-center">
        ...
        <div class="col-lg-4 col-md-5 col-sm-9 order-md-1 order-2 text-md-start text-center">
          ...
          <p class="mb-4 pb-3 fs-lg">
            Da circa trent’annni siamo impegnati nel settore immobiliare e imprenditoriale. 
            Il nostro lavoro si contraddistingue per la competenza e la chiarezza che i nostri 
            clienti ci hanno riconosciuto.
          </p>
          <nuxt-link class="btn btn-lg btn-primary" to="/contact-form">Contattaci</nuxt-link>
          <!--
    ...
    <section class="container mb-2 mb-xl-5 pb-lg-4">
      <h2 class="h3 mb-4">Perchè sceglierci?</h2>
      <!-- Features carousel-->
          ...
          <div>
            <div class="card border-0">
              <div class="card-body">
                ...
                <h3 class="h5 card-title pb-1">La tua soddisfazione è la nostra priorità</h3>
          ...
          <div>
            <div class="card border-0">
              <div class="card-body">
                ...
                <h3 class="h5 card-title pb-1">I prezzi migliori</h3>
          ...
          <div>
            <div class="card border-0">
              <div class="card-body">
                ...
                <h3 class="h5 card-title pb-1">Supporto 24/7</h3>
    ...
    <section class="container mb-5 pb-2 pb-lg-4">
      <div class="row gy-4">
        <div class="col-md-5 col-12">
          <img class="d-block mx-auto" src="img/real-estate/illustrations/find.svg" alt="Illustration"></div>
