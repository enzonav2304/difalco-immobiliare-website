        ...
        <div class="row align-items-md-center gy-4">
          <div class="col-lg-4 order-lg-1 order-2 position-relative py-lg-0 py-5 text-lg-start text-center">
            ...
            <div class="position-relative zindex-5">
              <h1 class="display-3 text-light">Area Riservata.</h1>
              <p class="mb-lg-4 mb-3 pb-lg-3 fs-lg text-light opacity-70">Benvenuto nella home. Autenticati tramite il link sotto.</p>
              ...
              <div class="pt-3">
                <a class="btn btn-lg btn-primary w-sm-auto w-100 mb-3 me-sm-4" href="#" @click="$auth.login()">Vai alla Home</a>
...
export default {
  ...
  computed: {
    /*getImage() {
      return require("../static/json/animation-real-estate-404.json")
    }*/
  }
}
</script>